...
class ProductVersion 
{
     ...
     * Add user
     *
     * @param \Ziiweb\UserBundle\Entity\User $user
     *
     * @return ProductVersion
     */
    public function addUser(\Ziiweb\UserBundle\Entity\User $user)
    {
        $this->users[] = $user;
     ...
     * @param \Ziiweb\UserBundle\Entity\User $user
     */
    public function removeUser(\Ziiweb\UserBundle\Entity\User $user)
    {
