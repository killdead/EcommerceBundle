...
class ProductVersionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('salePrice', null, array('label' => 'Precio rebajado (sin I.V.A.)', 'required' => false, 'attr' => array('class' => 'price',  'data-tax-rate' => \Ziiweb\EcommerceBundle\Entity\TaxRates::VAT_RATE + 1)))
